<?php
$page_title = 'Sorwatom - Product Name Here';
include '_head.php';
?>
<body>
        ...
        <div class="col-md-9 col-sm-7">
          ...
          <div class="text-center wow fadeInDown" data-wow-duration="1s" data-wow-delay=".5s">
            <div class="border-wrap">
              <span class="line-border-left"></span>
              <h3 class="center-content"><!-- Product type here, e.g. tomato paste --></h3>
            </div>
          </div>

          <!-- Product item -->
          <div class="products-details half_space wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".5s">
              <h3 class="product-header"><span><!-- Put Product Name, e.g. Tomato Paste --></span></h3>
                  ...
                  <div class="product-img">
                    <ul id="product-gal" class="gallery prod-gal-wrap list-unstyled cS-hidden">
                      <li data-thumb="img/product/tomatoes_paste_70g.png">
                        <!-- Place product's image file location in src -->
                        <img src="" class="img-responsive" loading="lazy" />
                        <h5 class="prod-gal-title"><!-- Put Product weight e.g. 70gm --></h5>
                      </li>
                    </ul>
                  </div>
                </div>
                    ...
                    <div class="acc-wrap">
                      <div class="acc-content open">
                        <div class="acc-content-inner">
                          <p><!-- Put Product Description Here-->
                          </p>
                        </div>
                      </div>
                    </div>
