        ...
        <div class="col-md-9 col-sm-7">
          ...
          <div class="text-center wow fadeInDown" data-wow-duration="1s" data-wow-delay=".5s">
            <div class="border-wrap">
              <span class="line-border-left"></span>
              <h3 class="center-content">Ketchup</h3>
              <span class="line-border-right"></span>
              <p></p>
            </div>
          </div>
          ...
          <div class="products-details half_space wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".5s">
            <h3 class="product-header"><span>Ketchup</span></h3>
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="product-img">
                  <ul id="product-gal" class="gallery prod-gal-wrap list-unstyled cS-hidden">
                    <li data-thumb="img/product/ketchup.png">
                      <img src="img/product/ketchup.png" class="img-responsive" loading="lazy" />
                  ...
                  <div class="acc-wrap">
                    <div class="acc-content open">
                      <div class="acc-content-inner">
                        <p>
                          Try our ketchup made from vine ripened tomatoes to give you a balanced blend of
                          spices to make a sweet and tangy sauce that goes well with any dish.
                        </p>
                      </div>
                    </div>
                  </div>
