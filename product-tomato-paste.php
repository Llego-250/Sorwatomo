...
<head>
  ...
  <title>Sorwatom - Tomato Paste</title>
                  ...
                  <div class="product-img">
                    <ul id="product-gal" class="gallery prod-gal-wrap list-unstyled cS-hidden">
                      <li data-thumb="img/product/tomatoes_paste_70g.png"> 
                        <img src="img/product/tomatoes_paste_70g.png" class="img-responsive" />
                  ...
                  <div class="product-img">
                    <ul id="product-gal" class="gallery prod-gal-wrap list-unstyled cS-hidden">
                      <li data-thumb="img/product/tomatoes_paste_50g.png"> 
                        <img src="img/product/tomatoes_paste_50g.png" class="img-responsive" />
                  ...
                  <div class="product-img">
                    <ul id="product-gal" class="gallery prod-gal-wrap list-unstyled cS-hidden">
                      <li data-thumb="img/product/tomatoes_paste_800g.png"> 
                        <img src="img/product/tomatoes_paste_800g.png" class="img-responsive" />
