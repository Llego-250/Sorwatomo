...
jQuery(function($) {
    ...
    // cheffs
    $("#our-product-content-1, #our-product-content-3").owlCarousel({
        autoPlay: 3000,
        items: 3,
        pagination: false,
        navigationText: ["<i class='fa fa-angle-left'></i>", "<i class='fa fa-angle-right'></i>"],
    ...
    $("#our-product-content-2, #our-product-content-5").owlCarousel({
        autoPlay: 7000,
        items: 3,
        pagination: false,
        navigationText: ["<i class='fa fa-angle-left'></i>", "<i class='fa fa-angle-right'></i>"],
    ...
    $("#our-product-content-4, #our-product-content-7").owlCarousel({
        autoPlay: 3000,
        items: 3,
        pagination: false,
        navigationText: ["<i class='fa fa-angle-left'></i>", "<i class='fa fa-angle-right'></i>"],
    ...
    $("#our-product-content-6, #our-product-content-8").owlCarousel({
        autoPlay: 7000,
        items: 3,
        pagination: false,
        navigationText: ["<i class='fa fa-angle-left'></i>", "<i class='fa fa-angle-right'></i>"],
    ...
    //  Blog Page
    $("#blog-slider,#blog-slider2").owlCarousel({
        autoPlay: true,
        singleItem: true,
        pagination: false,
        navigationText: ["<i class='fa fa-angle-left'></i>", "<i class='fa fa-angle-right'></i>"],
    ...
    $('#product-gal,#product-gal-2').lightSlider({
        gallery:true,
        item:1,
        thumbItem:3,
        slideMargin: 0,
        ...
        onSliderLoad: function() {
            $('#product-gal,#product-gal-2').removeClass('cS-hidden');
        }  
    });    
    ...
    if (contactForm.length) {
        ...
        contactForm.validator().on('submit', function (e) {
            ...
            if (e.isDefaultPrevented()) {
                ...
                $.ajax({
                    url: "vendor/php/contact_form.php",
                    type: "POST",
                    data: contactForm.serialize(),
                    beforeSend: function () {
                        $target.html("<div class='alert alert-info'><p>Message on its way</p></div>");
                    },
...
$('.navbar-default .navbar-nav a[href="' + url + '"]').parents('li,ul').addClass('active').parent().addClass('active');

// Will also work for relative and absolute hrefs
$('.navbar-default .navbar-nav a').filter(function() {
    return this.href == url;
}).parents('li,ul').addClass('active').parent().addClass('active');
$('.navbar-default .navbar-nav a').parents('ul').removeClass('active');

var url = window.location;
// Will only work if string in href matches with location
$('.widget_links > li > a[href="' + url + '"]').parents('li,ul').addClass('active').parent().addClass('active');

// Will also work for relative and absolute hrefs
$('.widget_links > li > a').filter(function() {
    return this.href == url;
}).parents('li,ul').addClass('active').parent().addClass('active');
$('.widget_links > li > a').parents('ul').removeClass('active');
...
/*jQuery(function ($) {
    $('.showSingle').click(function () {
        ...
        if ($('.show-active').length === 0) {
            ...
            $(itemid).addClass('show-active');

            //Hide the element if it is shown.
        } else if (itemid == "#" + $('.show-active').attr('id')) {
            $('.show-active').slideUp('slow');
            $(itemid).removeClass('show-active');

            //Otherwise, switch out the current element for the next one sequentially.
        } else {
            $('.show-active').slideUp(function () {
...
$(document).ready(function(){
  ...
  $(document).on('touchstart click', '.acc-btn', function(){
    if(!clickPolice){
      ...
      $('.acc-btn .acc-t').removeClass('selected');
      $(this).find('.acc-t').addClass('selected');
...
// ======================================================
$(function(){
  var $gallery = $('a.fancybox, .fancybox > .photo_frame > a').simpleLightbox();
...
$(function(){
  var $gallery = $('.fancybox li a').simpleLightbox();
